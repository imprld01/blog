			...
			{% for post in site.categories.Top-Post %}
				<li class="wrapper style2">
					...
					<p>
						...
						<a href="{{ site.url }}{{ site.baseurl }}{{ post.url }}#disqus_thread" data-disqus-identifier="{{ post.url }}">p</a>
					</p>
					{{ post.excerpt }}
				...
				{% unless post.categories contains 'Top-Post' %}
					<li class="wrapper style1">
						...
						<p>
							...
							{% endfor %}
							<span class="icon fa-comment"></span>
							<a href="{{ site.url }}{{ site.baseurl }}{{ post.url }}#disqus_thread" data-disqus-identifier="{{ post.url }}"></a>
						</p>
						{{ post.excerpt }}
						<section class="special">
							<ul class="buttons">
